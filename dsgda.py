...
from gpu_work import Worker, Minmax_Worker
...
def run(args):
    ...
    for rank in range(args.nodes):
        ...
        worker = Worker(rank, model, train_loader, criterion, optimizer, schedule, args)
    ...
    fname = str(args.keep) + 'dsgd_static' + args.topo + args.datasets + args.model + str(args.nodes)
